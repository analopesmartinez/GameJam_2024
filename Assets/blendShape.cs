...
public class blendShape : MonoBehaviour
{
    ...
    void Update()
    {
        renderer.SetBlendShapeWeight(0, (Mathf.Cos(Time.time*20f * (laughterScript.noise*2f)) * laughterScript.noise * 20f));
        renderer.SetBlendShapeWeight(1, (1+Mathf.Sin(Time.time*20f * (laughterScript.noise * 2f)) *200 * laughterScript.noise));
